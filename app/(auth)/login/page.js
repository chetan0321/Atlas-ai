      ...
      <div style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
            <label style={{ fontSize: '13px', fontWeight: '500', color: 'rgba(255,255,255,0.65)' }}>Password</label>
            <Link href="/forgot-password" style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)', textDecoration: 'underline', textUnderlineOffset: '2px' }}>
              Forgot password?
            </Link>
          </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
          ...
          <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.28)' }}>or continue with</span>
          <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.08)' }} />
        </div>
